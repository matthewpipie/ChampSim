//=======================================================================================//
// File             : berti_4kb/berti_4kb_helper.h
...
void berti_4kb::prefetcher_initialize()
{
...
uint32_t berti_4kb::prefetcher_cache_operate(champsim::address address, champsim::address ip_addr, uint8_t cache_hit, bool useful_prefetch, access_type type,
...
uint32_t berti_4kb::prefetcher_cache_fill(champsim::address address, long set, long way, uint8_t prefetch, champsim::address evicted_address, uint32_t metadata_in)
{
  uint64_t addr = address.to<uint64_t>();
  ...
  uint64_t victim_index = l1d_get_current_pages_entry(evicted_addr >> (LOG2_BLOCK_SIZE + L1D_PAGE_BLOCKS_BITS));
...
void berti_4kb::prefetcher_cycle_operate() {}
