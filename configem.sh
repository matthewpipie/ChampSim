...
#ns="4"
ns="1"
export DYNAMORIO=1  # exported so build.py -> make inherits it (enables dr.mk)
...
for n in $ns; do
    ...
    #l2cs="l2c.n.v1..json"
    l2cs="l2c.n.v1.replacement--lru.json"
    ...
    llcs="llc.$n.v2.replacement--lru.json"
