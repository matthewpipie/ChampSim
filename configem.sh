...
for n in $ns; do
    ...
    #l1is="l1i.n.v1.prefetcher--eip+sets--256.json"
    ...
    #l1ds="l1d.n.v1.prefetcher--berti_4kb+sets--128.json"
    ...
    #l2cs="l2c.n.v1.prefetcher--pythia_4kb+sets--512.json"
    ...
    #cores="core.$n.v1.page_size--4096.json"
