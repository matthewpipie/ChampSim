...
BASE_DIR = "/mnt/storage/traces/gtrace_v2_champsim_perthread_1.5Binstr/"
OUT_DIR = f"results_perthread_1/{executable_name}"
...
for workload in workloads:
    ...
    for i, trace_file_batch in enumerate(list(grouper(trace_files, N_CORES_PER_PROCESS, incomplete="strict"))):
        ...
        outname = f"{workload},{i:04},{N_CORES_PER_PROCESS},{i*N_CORES_PER_PROCESS:04}.raw"
